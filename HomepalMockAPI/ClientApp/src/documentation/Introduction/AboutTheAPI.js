        ...
        <Description>
          <TextUnit header="Homebase API" headerSize="3">
            ...
            <p>
              ...
              <a href="https://restfulapi.net/" target="_blank" rel="noopener noreferrer">REST principles</a>. All routes
              described are protected and requires a key-based authentication. 
              The responses of the API are based on{" "}
              <a href="https://jsonapi.org" target="_blank" rel="noopener noreferrer">https://jsonapi.org</a>. Error
              handling is done via{" "}
              <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes" target="_blank" rel="noopener noreferrer">
            ...
            <p>
              The documentation starts of by describing general information about the API that is always applied, and is later organized by resource type of the API. For each resource
              type, the documentation lists:
            </p> 
            <ul>
            ...
            <p className="small">
              ...
              every now and then, and endpoints are deprecated. If you are using the API make sure to check in on {" "}
