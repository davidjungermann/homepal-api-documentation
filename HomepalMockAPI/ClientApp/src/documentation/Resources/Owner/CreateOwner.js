...
export const CreateOwner = ({ history, token, setCurrentSection }) => {
  return (
    <Section
      id="create-owner"
      history={history}
    ...
    >
      <Description>
        ...
        <Table
          ...
          values={[
            {
              col1: (
                <TableItem description="The name of Owner subject for creation.">
                  id
                </TableItem>
              ),
              col2: "Integer",
      ...
      <Usage>
        <EndpointExample header="Endpoint" copy baseUrl="api/owners">
          <Endpoint request="POST" baseUrl="api/owners"></Endpoint>
        </EndpointExample>
